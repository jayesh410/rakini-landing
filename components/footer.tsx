...
export default function Footer() {
  return (
    <footer className="border-t py-12 bg-gray-100 bg-grid-pattern bg-opacity-10">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-6 px-5">
        ...
        <div className="flex items-center space-x-2">
          ...
          />
          <span className="text-sm">© 2024 Rakini. All rights reserved.</span>
        </div>
        ...
        <div className="flex flex-col items-center space-y-2 text-sm text-muted-foreground text-left">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span>support@rakini.com</span>
            </a>
            
          </div>
          <div className="flex items-center space-x-2">
            <MapPin size={16} />
            <a href="https://www.google.com/maps/search/18.600847,+73.813774?entry=tts&g_ep=EgoyMDI0MDYyNS4wKgBIAVAD" target="_blank" rel="noopener noreferrer">
